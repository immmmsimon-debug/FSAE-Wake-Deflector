...
- The baseline configuration was analyzed using CFD, focusing on total pressure (CPt) distribution. Lower CPt regions correspond to higher-speed flow, or turbulance zone. The way that we can differenciate is by looking at the shape of the and the way it change, since a vortex would be circular and push air arround it in the dircection of its rotation while turbulance would seem chaotic and unpredictable. 
